...
# Targets
all: p3.c types.h shell.h historicList.h libp0.h filesList.h libp1.h libp2.h libp3.h memoryList.h vars.c shell.o historicList.o libp0.o filesList.o libp1.o libp2.o libp3.o memoryList.o
	$(CC) $(CFLAGS) -o p3 p3.c shell.o historicList.o libp0.o filesList.o libp1.o libp2.o libp3.o memoryList.o vars.c
